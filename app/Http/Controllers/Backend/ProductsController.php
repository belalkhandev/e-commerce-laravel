...
class ProductsController extends Controller
{
    ...
    public function getProductsPageLoad() {
        ...
        return view('backend.products', compact('AllCount', 'PublishedCount', 'DraftCount', 'languageslist', 'categorylist', 'brandlist', 'collectionlist', 'storeList', 'datalist'));		
	}
    ...
    public function getProductPageData($id){
        ...
        return view('backend.product', compact('datalist', 'statuslist', 'languageslist', 'brandlist', 'categorylist', 'collectionlist', 'labellist', 'taxlist', 'media_datalist', 'storeList'));
    }
