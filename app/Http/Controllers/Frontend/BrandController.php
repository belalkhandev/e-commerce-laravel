...
class BrandController extends Controller
{
    ...
    public function getBrandPage($id, $title){
        ...
        return view('frontend.brand', compact('params', 'metadata', 'datalist'));
    }
	
	//Get data for Brand Pagination
	public function getBrandGrid(Request $request){

		$cat_ids = isset($request->categories) ? $request->categories : '';
		...
		if($request->ajax()){
			...
			return view('frontend.partials.brand-grid', compact('datalist'))->render();
		}
	}
}
