			...
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="row mt10 mb5">
						<div class="col-md-12">
							<a href="{{ route('frontend.register') }}" class="btn white-btn text-initial mr10 font-bold active">{{ __('I am a customer') }}</a>
							<a href="{{ route('frontend.seller-register') }}" class="btn white-btn text-initial font-bold">{{ __('I am a seller') }}</a>
						</div>
					</div>
					<div class="register">
