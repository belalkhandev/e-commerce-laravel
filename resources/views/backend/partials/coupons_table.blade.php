	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:25%">{{ __('Code') }}</th>
				<th class="text-center" style="width:25%">{{ __('Expire Date') }}</th>
				<th class="text-right" style="width:15%">{{ __('Percentage') }} %</th>
				<th class="text-center" style="width:25%">{{ __('Status') }}</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">{{ $row->expire_date }}</td> 
