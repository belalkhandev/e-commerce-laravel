	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:25%">{{ __('Attribute Type') }}</th>
				<th class="text-left" style="width:40%">{{ __('Name') }}</th>
				<th class="text-center" style="width:25%">{{ __('Color') }}</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center"><span class="label_color" style="background:{{ $row->color }};">{{ $row->color }}</span></td>
