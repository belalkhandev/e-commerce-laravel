							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="desc">{{ __('Slider') }}<span class="red">*</span></label>
										<input type="text" name="desc" id="desc" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="image_url">{{ __('URL') }}<span class="red">*</span></label>
										<input type="text" name="image_url" id="image_url" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="slider_image">{{ __('Image') }}<span class="red">*</span></label>
										...
										<em>Recommended image size width: 970px and height: 400px.</em>
