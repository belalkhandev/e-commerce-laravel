			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.coupons_table')
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="code">{{ __('Code') }}<span class="red">*</span></label>
										<input type="text" name="code" id="code" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="expire_date">{{ __('Expire Date') }}<span class="red">*</span></label>
										<input type="text" name="expire_date" id="expire_date" class="form-control parsley-validated" data-required="true" placeholder="yyyy-mm-dd">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" name="percentage" id="percentage" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
