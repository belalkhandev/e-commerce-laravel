			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.labels_table')
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>{{ __('Color') }}<span class="red">*</span></label>
										<div id="color-picker" class="input-group tw-picker">
											<input name="color" id="color" type="text" value="#38a677" class="form-control parsley-validated" data-required="true" />
...
<script src="{{asset('public/backend/pages/labels.js')}}"></script>
@endpush