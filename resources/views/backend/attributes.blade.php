				...
				<div class="card">
					...
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="att_type">{{ __('Attribute Type') }}<span class="red">*</span></label>
										<select name="att_type" id="att_type" class="chosen-select form-control">
							...
							<div class="row" id="color_picker">
								<div class="col-md-6">
									<div class="form-group">
										<label>{{ __('Color') }}</label>
										<div id="color-picker" class="input-group tw-picker">
											<input name="color" id="color" type="text" value="#38a677" class="form-control" />
