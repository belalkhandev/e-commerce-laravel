...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getReviewRatingsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getReviewRatingsTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getReviewRatingsTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/deleteReviewRatings',
		data: 'id='+RecordId,
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/bulkActionReviewRatings',
